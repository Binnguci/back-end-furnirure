...
public class CartController {
    ...
    public ResponseEntity<APIResponse<CartDTO>> getCartByUserId(@PathVariable Integer id) {
        ...
        return ResponseBuilder.buildResponse(cart, (cart != null) ? ErrorCode.FOUND : ErrorCode.CART_NOT_FOUND);
    }
    ...
    public ResponseEntity<APIResponse<CartItemDTO>> getCartByUserId(@RequestBody CartItemDTO cartItemDTO) {
        ...
        return ResponseBuilder.buildResponse(cartItem, (cartItem != null) ? ErrorCode.CREATE_SUCCESS : ErrorCode.CREATE_FAILED);
    }
    ...
    public ResponseEntity<APIResponse<CartItemDTO>> updateCartItem(@PathVariable String id, @RequestParam Integer quantity) {
        ...
        return ResponseBuilder.buildResponse(cartItem, (cartItem != null) ? ErrorCode.UPDATE_SUCCESS : ErrorCode.UPDATE_FAILED);
    }
